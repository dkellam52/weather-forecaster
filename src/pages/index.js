...
class Homepage extends Component {
  ...
  async fetchForecastData(payload = { q: this.state.location }) {
    try {
      ...
      let errorMessage = '';
      if(status === 404) {
        errorMessage = 'Your location cannot be found. Please be sure to include City and Country Code. ie. Lexington,KY';
      } else {
      ...
      <Layout>
          ...
          <form className="searchForm" onSubmit={this.handleSubmit} autoComplete="off">
            ...
            <div className="searchForm__inner">
              <input id="search" className="searchForm__input" type="text" placeholder="ie Lexington,KY" value={this.state.location} onChange={this.handleChange} />
